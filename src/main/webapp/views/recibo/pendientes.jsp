...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="display-5 fw-semibold text-warning">
            <i class="bi bi-clock-history me-2"></i>Recibos Pendientes
        </h1>
                ...
                <table class="table table-hover table-striped mb-0">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th><i class="bi bi-cash"></i> ACCIONES</th>
                        </tr>
                    </thead>
                    <tbody>
                        <%
                            List<Object[]> lista = (List<Object[]>) request.getAttribute("listaPendientes");
                        ...
                        <tr>
                            ...
                            <td><%= r[5] %></td>
                            <td class="fw-semibold text-danger">$ <%= String.format("%,.2f", total) %></td>
                            <td>
                            ...
                            <td>
                                <a class="btn btn-success btn-sm" 
                                   href="${pageContext.request.contextPath}/recibo?accion=pagar&id=<%= r[0] %>"
                                   onclick="return confirm('¿Confirmar pago de este recibo?')">
